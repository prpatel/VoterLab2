...
// in simulator we redefine to format for VoterLab Developer console
...
{\
	NSString * exceptionName = [@"org.voterlab." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voterlab";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoterLabNativeItemNone = -1, 
	UIVoterLabNativeItemSpinner = -2,
	UIVoterLabNativeItemProgressBar = -3,
	
	UIVoterLabNativeItemSlider = -4,
	UIVoterLabNativeItemSwitch = -5,
	UIVoterLabNativeItemMultiButton = -6,
	UIVoterLabNativeItemSegmented = -7,
	
	UIVoterLabNativeItemTextView = -8,
	UIVoterLabNativeItemTextField = -9,
	UIVoterLabNativeItemSearchBar = -10,
	
	UIVoterLabNativeItemPicker = -11,
	UIVoterLabNativeItemDatePicker = -12,
	
	UIVoterLabNativeItemInfoLight = -13,
	UIVoterLabNativeItemInfoDark = -14,
	
	UIVoterLabNativeItemDisclosure = -15,
	
	UIVoterLabNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VoterLab instances of
