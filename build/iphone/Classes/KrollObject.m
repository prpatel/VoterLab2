...
//@interface VoterLabObject : NSObject
//@end

@interface VoterLabObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VoterLabObject class]])
		{
			for (NSString *key in [[(VoterLabObject*)o modules] allKeys])
			{
